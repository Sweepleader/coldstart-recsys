...
def parse_args():
    ...
    p.add_argument('--tower', type=str, default='baseline', choices=['baseline','twolayer','bidirectional','twotwo','improved','timeaware','timeaware_attention','baseline_timeaware', 'timeaware_attention2'])
